...
RegisterNetEvent('qb-mechanicjob:server:removeItem', function(part, amount)
    ...
    if not exports['tgiann-inventory']:RemoveItem(src, part, amount, false, 'qb-mechanicjob:server:removeItem') then DropPlayer(src, 'qb-mechanicjob:server:removeItem') end
