        ...
        if WeaponChance ~= odd1 then
            if tier ~= 4 then
                if Config.RewardTypes[itemType].type == 'item' then
                    ...
                    exports['tgiann-inventory']:AddItem(src, item.item, itemAmount, false, false, 'qb-bankrobbery:server:recieveItem')
                ...
                elseif Config.RewardTypes[itemType].type == 'money' then
                    ...
                    exports['tgiann-inventory']:AddItem(src, 'markedbills', math.random(2, 3), false, info, 'qb-bankrobbery:server:recieveItem')
                    TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items['markedbills'], 'add')
                end
            else
                exports['tgiann-inventory']:AddItem(src, 'security_card_01', 1, false, false, 'qb-bankrobbery:server:recieveItem')
                TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items['security_card_01'], 'add')
            end
        else
            exports['tgiann-inventory']:AddItem(src, 'weapon_stungun', 1, false, false, 'qb-bankrobbery:server:recieveItem')
            TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_stungun'], 'add')
        end
        ...
        if WeaponChance ~= odd1 then
            if tier ~= 4 then
                ...
                elseif Config.RewardTypes[itemType].type == 'money' then
                    ...
                    exports['tgiann-inventory']:AddItem(src, 'markedbills', math.random(1, 4), false, info, 'qb-bankrobbery:server:recieveItem')
                    TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items['markedbills'], 'add')
                end
            else
                exports['tgiann-inventory']:AddItem(src, 'security_card_02', 1, false, false, 'qb-bankrobbery:server:recieveItem')
                TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items['security_card_02'], 'add')
            end
        else
            exports['tgiann-inventory']:AddItem(src, 'weapon_vintagepistol', 1, false, false, 'qb-bankrobbery:server:recieveItem')
    ...
    elseif type == 'pacific' then
        ...
        if WeaponChance ~= odd1 or WeaponChance ~= odd2 then
            if tier ~= 4 then
                ...
                exports['tgiann-inventory']:AddItem(src, 'cryptostick', 1, false, info, 'qb-bankrobbery:server:recieveItem')
            ...
            if chance == odd then
                exports['tgiann-inventory']:AddItem(src, 'weapon_microsmg', 1, false, false, 'qb-bankrobbery:server:recieveItem')
                TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_microsmg'], 'add')
            else
                exports['tgiann-inventory']:AddItem(src, 'weapon_minismg', 1, false, false, 'qb-bankrobbery:server:recieveItem')
...
RegisterNetEvent('qb-bankrobbery:server:removeElectronicKit', function()
    ...
    exports['tgiann-inventory']:RemoveItem(src, 'electronickit', 1, false, 'qb-bankrobbery:server:removeElectronicKit')
    TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items['electronickit'], 'remove')
    exports['tgiann-inventory']:RemoveItem(src, 'trojan_usb', 1, false, 'qb-bankrobbery:server:removeElectronicKit')
...
RegisterNetEvent('qb-bankrobbery:server:removeBankCard', function(number)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
    exports['tgiann-inventory']:RemoveItem(src, 'security_card_' .. number, 1, false, 'qb-bankrobbery:server:removeBankCard')
...
QBCore.Functions.CreateCallback('thermite:server:check', function(source, cb)
    ...
    if exports['tgiann-inventory']:RemoveItem(source, 'thermite', 1, false, 'thermite:server:check') then
