...
local function giveStarterItems()
    ...
    for _, v in pairs(QBCore.Shared.StarterItems) do
        ...
        exports['tgiann-inventory']:AddItem(source, v.item, 1, false, info, 'qb-cityhall:giveStarterItems')
    end
end
...
RegisterNetEvent('qb-cityhall:server:requestId', function(item, hall)
    ...
    if not exports['tgiann-inventory']:AddItem(source, item, 1, false, info, 'qb-cityhall:server:requestId') then return end
