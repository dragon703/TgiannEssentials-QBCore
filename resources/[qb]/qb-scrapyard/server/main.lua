...
RegisterNetEvent('qb-scrapyard:server:ScrapVehicle', function(listKey)
    ...
    if Config.CurrentVehicles[listKey] ~= nil then
        for _ = 1, math.random(2, 4), 1 do
            ...
            exports['tgiann-inventory']:AddItem(src, item, math.random(25, 45), false, false, 'qb-scrapyard:server:ScrapVehicle')
        ...
        if Luck == Odd then
            ...
            exports['tgiann-inventory']:AddItem(src, 'rubber', random, false, false, 'qb-scrapyard:server:ScrapVehicle')
