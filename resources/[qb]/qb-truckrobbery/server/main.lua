...
RegisterServerEvent('AttackTransport:graczZrobilnapad', function()
	...
	exports['tgiann-inventory']:AddItem(_source, 'markedbills', bags, false, info, 'AttackTransport:graczZrobilnapad')
	...
	if chance >= 95 then
		exports['tgiann-inventory']:AddItem(_source, 'security_card_01', 1, false, false, 'AttackTransport:graczZrobilnapad')
