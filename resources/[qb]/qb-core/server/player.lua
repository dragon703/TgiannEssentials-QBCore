...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    if GetResourceState('qb-inventory') ~= 'missing' then
        PlayerData.items = exports['tgiann-inventory']:LoadInventory(PlayerData.source, PlayerData.citizenid)
    end
...
function QBCore.Player.Save(source)
    ...
    if PlayerData then
        ...
        if GetResourceState('qb-inventory') ~= 'missing' then exports['tgiann-inventory']:SaveInventory(source) end
...
function QBCore.Player.SaveOffline(PlayerData)
    if PlayerData then
        ...
        if GetResourceState('qb-inventory') ~= 'missing' then exports['tgiann-inventory']:SaveInventory(PlayerData, true) end
...
function QBCore.Player.SaveInventory(source)
    ...
    exports['tgiann-inventory']:SaveInventory(source, false)
end

function QBCore.Player.SaveOfflineInventory(PlayerData)
    if GetResourceState('qb-inventory') == 'missing' then return end
    exports['tgiann-inventory']:SaveInventory(PlayerData, true)
end

function QBCore.Player.GetTotalWeight(items)
    if GetResourceState('qb-inventory') == 'missing' then return end
    return exports['tgiann-inventory']:GetTotalWeight(items)
end

function QBCore.Player.GetSlotsByItem(items, itemName)
    if GetResourceState('qb-inventory') == 'missing' then return end
    return exports['tgiann-inventory']:GetSlotsByItem(items, itemName)
end

function QBCore.Player.GetFirstSlotByItem(items, itemName)
    if GetResourceState('qb-inventory') == 'missing' then return end
    return exports['tgiann-inventory']:GetFirstSlotByItem(items, itemName)
end
