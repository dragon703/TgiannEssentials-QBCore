...
config.tattoo.useGtaOnlinePrice = true
...
config.tattoo.randomPrice = {
    ["torso"] = { min = 1000, max = 2500 },     -- torso
    ["head"] = { min = 1000, max = 2500 },      -- head
    ["left_arm"] = { min = 1000, max = 2500 },  -- left_arm
    ["right_arm"] = { min = 1000, max = 2500 }, -- right_arm
    ["left_leg"] = { min = 1000, max = 2500 },  -- left_leg
    ["right_leg"] = { min = 1000, max = 2500 }, -- right_leg
}
